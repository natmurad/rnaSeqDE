...
counts_dir="/your/counts/directory/"
norm_output="/where/write/normalized/output"
DGE_output="/where/write/DEresults"
...
string_db <- STRINGdb$new( version="11.5", 
                           species=organism_table$taxon[organism_table$name == organism],
                           score_threshold=0)
